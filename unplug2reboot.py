#!/usr/bin/env python
# unplug2reboot.py
# This script allows you to designate a USB device that when removed, reboots the system
#
...
class Main:
    def __init__(self,args):
		...
		pijuice.rtcAlarm.SetWakeupEnabled(False) # disable any wake up scheduled in pijuice
		#pijuice.power.SetSystemPowerSwitch(0)
		#pijuice.power.SetPowerOff(60)
                os.system("reboot")
		#s.system("sudo i2cset -y 1 0x6B 0x00 0xcc b") #for pico ups
